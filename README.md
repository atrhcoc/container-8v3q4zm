...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-8v3q4zm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-8v3q4zm.containers.anotherwebservice.com/
...
```
git clone git@github.com:atrhcoc/container-8v3q4zm.git
cd container-8v3q4zm
```
...
```
docker attach container-8v3q4zm
```
